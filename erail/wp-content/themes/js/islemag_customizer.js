...
jQuery( document ).ready(
	function () {
		...
		jQuery( '#customize-theme-controls' ).on(
			'change', '.islemag-banner-select', function () {
		...
		jQuery( '#customize-theme-controls' ).on(
			'change', '.islemag-banner-position', function () {
				islemag_refresh_banner_control();
				return false;
			}
		);
		...
		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.islemag-banner-link', function () {
				islemag_refresh_banner_control();
				return false;
			}
		);
		...
		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.islemag-banner-settings-text-control', function () {
				islemag_refresh_banner_control();
				return false;
			}
		);
