...
function pnr_status($pnrnumber){
	$url = 'https://api.railwayapi.com/v2/pnr-status/pnr/'.$pnrnumber.'/apikey/zb3d8fr6ef/'; 
	//$jsondata = file_get_contents('http://www.goibibo.com/trains/bnc-suvidha-spl-08451/');
	$jsondata = file_get_contents($url);
	//echo print_r($jsondata);die();
	return json_decode($jsondata, true);
		
}
function running_status($train_number,$doj){
	$url = 'https://api.railwayapi.com/v2/live/train/'.$train_number.'/date/'.$doj.'/apikey/zb3d8fr6ef/'; 
...
function train_between_stations($source_code, $dest_code, $doj){
	$url = 'https://api.railwayapi.com/v2/between/source/'.$source_code.'/dest/'.$dest_code.'/date/'.$doj.'/apikey/zb3d8fr6ef/';
...
function train_schedule($train_number){
	...
	$url = 'https://api.railwayapi.com/v2/route/train/'.$train_number.'/apikey/zb3d8fr6ef/';
...
function trains_arrival($station_code,$hours)
	{
		...
		$url = 'https://api.railwayapi.com/v2/arrivals/station/'.$station_code.'/hours/'.$hours.'/apikey/zb3d8fr6ef/';
	...
	function train_information($train_number){
		...
		$url = 'https://api.railwayapi.com/v2/name-number/train/'.$train_number.'/apikey/zb3d8fr6ef/';
	...
	function cancelled($cancelled_date){
		...
		$url = 'https://api.railwayapi.com/v2/cancelled/date/'.$date.'/apikey/zb3d8fr6ef/';
		//echo print_r($date);
		$jsondata = file_get_contents($url);
		//echo print_r($jsondata);die();
		return json_decode($jsondata, true);
	...
	function rescheduled_trains($jurney_date){
		...
		$url = 'https://api.railwayapi.com/v2/rescheduled/date/'.$doj.'/apikey/zb3d8fr6ef/';
		$jsondata = file_get_contents($url);
		//echo print_r($jsondata);die();
		return json_decode($jsondata, true);
	}
	...
	function seat_availability($train_number,$seat_class,$source_code,$dest_code,$quota ,$doj ){
		
		$doj = str_replace('_','-',$doj);
		$url = 'https://api.railwayapi.com/v2/check-seat/train/'.$train_number.'/source/'.$source_code.'/dest/'.$dest_code.'/date/'.$doj.'/class/'.$seat_class.'/quota/'.$quota.'/apikey/zb3d8fr6ef/';
	...
	function train_fare_enquiry($train_number,$src,$dest,$age,$quota,$doj,$seat_class)
	{
		...
		$doj = str_replace('_','-',$doj);
		$url = 'https://api.railwayapi.com/v2/fare/train/'.$train_number.'/source/'.$src.'/dest/'.$dest.'/age/'.$age.'/pref/'.$seat_class.'/quota/'.$quota.'/date/'.$doj.'/apikey/zb3d8fr6ef/';

		$jsondata = file_get_contents($url);
		//etcho print_r($jsondata);die();
		return json_decode($jsondata, true);
	}
...
/*register_confirmation_fields(3 array(9, 7));*/
     ...
     jQuery('#input_7_8').bind('change', function()
        {
            ...
            var selectedValue = jQuery("#input_7_8").val();
...
jQuery('#input_6_8').bind('change', function()
        {
            ...
            var choosenvalue = jQuery("#input_6_8").val();
